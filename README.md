...
[![Spec: draft v0.4](https://img.shields.io/badge/spec-draft%20v0.4-orange.svg)](spec/PQF-SPEC-v1.md)
...
> **Preview:** `pqf` is published as `0.4.0-preview.*`. The wire format is still draft v0.4 — files produced by previews are not guaranteed to be readable by `v1.0.0`.
...
- A **file format specification** ([spec/PQF-SPEC-v1.md](spec/PQF-SPEC-v1.md), draft v0.4).
...
spec/                            Format definition and design rationale
  PQF-SPEC-v1.md                 Normative specification (v0.4 draft)
...
- **Status:** Experimental. Specification is at draft v0.4.
...
| Spec frozen? | Draft v0.4 (v1.0.0 target) | Stable | Stable (RFC) | Stable (Google) | Stable |
