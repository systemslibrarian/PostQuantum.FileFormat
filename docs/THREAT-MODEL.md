...
primitives (classical X25519 + AES-256-GCM, or post-quantum ML-KEM-768)
...
- Confidentiality holds as long as ML-KEM-768 holds, even if X25519 is
  fully broken by quantum methods.
- Confidentiality also holds as long as X25519 + AES-256 hold, even if
  ML-KEM-768 is later broken by classical cryptanalysis.
...
- KEM implicit-rejection: ML-KEM-768's spec-defined implicit-rejection
